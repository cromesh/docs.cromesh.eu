...
- **Česta pitanja** — česta pitanja početnika, o zajednici i pravila ponašanja i regulativa
- **MeshCore** — MeshCore, hrvatska zajednica, usporedba s Meshtastic-om i osnovne informacije o protokolu
...
└─ v3.4            Novi ogranak: MeshCore integracija
   ...
   └─ v3.4.3        MeshCore izdvojen u zasebni tab pod Česta pitanja; FAQ ponovno usmjeren na opća pitanja
```
## Changelog
### v3.4.3 — MeshCore zasebni tab
- **Navigacija:** dodan zaseban tab **MeshCore** unutar skupine „Česta pitanja”, odmah nakon „Pravila”.
- **FAQ:** tema **„MeshCore - kako i zašto?”** uklonjena je iz općeg FAQ-a kako se sadržaj ne bi duplicirao.
- **MeshCore:** sadržaj je premješten na zasebnu MeshCore stranicu i ostaje strukturiran kao neutralan pregled protokola, usporedbe s Meshtastic-om, poveznica i pravne napomene.
- **README:** struktura dokumentacije i verzija ažurirane su kako bi odražavale novu navigaciju.
