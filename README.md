...
└─ v3.4            MeshCore integracija
   ...
   └─ v3.5.0        Redizajnirana naslovnica s CroMesh pozadinskom slikom i prilagođenim vizualnim stilom
```

## Changelog

### v3.5.0 — novi vizualni izgled naslovnice
- **Naslovnica:** uveden novi CroMesh landing-page dizajn s mrežnom pozadinskom slikom Hrvatske.
- **Vizualni stil:** dodani tamni prozirni paneli, CroMesh crveni naglasci, novi hero dio i brzi pristup vodičima.
- **Navigacija:** postojeća MkDocs Material infrastruktura i sadržaj dokumentacije ostaju zadržani.
- **Resursi:** dodana optimizirana pozadinska slika u `docs/assets/images/`.
- **Stilovi:** dodan `docs/stylesheets/extra.css` za landing-page izgled.
