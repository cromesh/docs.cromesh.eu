...
description: Službena dokumentacija za CroMesh mrežu i Meshtastic konfiguraciju.
tags:
  - CROMESH
  - Dokumentacija
  - Meshtastic
...
<div class="cromesh-hero" markdown>
# Dobrodošli u<br><span class="cromesh-accent">CroMesh</span> dokumentaciju

Sve što trebate za izgradnju, korištenje i razumijevanje CroMesh mreže — na jednom mjestu.

**Otvoreno. Neovisno. Za zajednicu.**

<div class="cromesh-actions" markdown>
...
<div class="cromesh-feature-grid" markdown>
<div class="cromesh-feature-card" markdown>
...
<div class="cromesh-quick-card" markdown>
:octicons-rocket-24:
**Prvi koraci**
...
<div class="cromesh-home-note" markdown>
